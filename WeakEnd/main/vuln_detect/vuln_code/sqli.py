        ...
        if col_num('get',union_middle_form, cookies) != False:
            ...
            for payload in data:
                try:
                    ...
                    true_payload, false_payload = payload.split('\t')
                    check_list = {"ubuntu","SQL Server","Microsoft SQL Server","Oracle","Postre SQL","MYSQL", "MSSQL", "Microsoft JET Database Engine", "ORA-00933:","PSQLException"}
            ...
            if col_num(target, table_form, cookies) != False:
                ...
                for payload_name in key_list:
                    for bool_pay in bool_data:
                        try:
                            true_payload, false_payload = bool_pay.split('\t')
                            check_list = {"ubuntu","MYSQL","SQL Server","Microsoft SQL Server","Oracle","Postre SQL", "MSSQL", "Microsoft JET Database Engine", "ORA-00933:","PSQLException"}
                            if true_payload.startswith('admin'):
                                break
